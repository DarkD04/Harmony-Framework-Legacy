...
//Fuck all lmao
    ...
    instance_activate_object(MusicObject);
    instance_activate_object(Window);   
	...
	switch(Section){
		...
		case 2: Select = clamp(Select,0,array_length(Stages)-1) break;	
		case 3: Select = clamp(Select,0,array_length(Unfinished)-1) break;	
	}
	//Enter Selections
